export const NAV_ITEMS = ['Home', 'About Us', 'Services', 'Contact']
...
export const homePromises = ['Stroke care', 'Migraine care', 'Neurology tests', 'Follow-up care']

export const doctors = [
  {
    name: 'Dr. Ashish Bhutada',
  ...
  {
    name: 'Dr. Poonam Bhutada (Dr. Poonam Bajaj Bhutada)',
    role: 'Endocrinologist',
    note: 'Super-specialist in hormones, thyroid, and diabetes — 11+ years experience.',
    extra:
      'Core focus: Diabetes mellitus and thyroid disorders',
    initials: 'PB',
    portrait:
...
export const investigationTags = ['EEG', 'NCV / EMG', 'VEP', 'BAEP']
